...
VALUES
  (
    ...
    10,
    15,
    'Write a 15-page space adventure story where {childName}, a {childAge}-year-old explorer, embarks on a journey through the solar system. The story should include educational facts about planets while maintaining an exciting narrative.',
  ...
  (
    ...
    8,
    15,
    'Write a 15-page fantasy story where {childName}, a {childAge}-year-old child, discovers a magical forest near their home. The forest has talking animals, magical creatures, and teaches lessons about friendship and courage.',
  ...
  (
    ...
    9,
    15,
    'Write a 15-page underwater adventure where {childName}, a {childAge}-year-old marine explorer, discovers the wonders of the ocean. Include educational elements about sea creatures and ocean conservation.',
  ...
  (
    ...
    10,
    15,
    'Write a 15-page medieval adventure where {childName}, a {childAge}-year-old brave knight, goes on a quest to help their kingdom. The story should emphasize courage, kindness, and problem-solving.',
  ...
  (
    ...
    8,
    15,
    'Write a 15-page story where {childName}, a {childAge}-year-old animal lover, helps rescue and care for different animals. Include educational facts about animal care and habitats.',
