            ...
            <div className="bg-white rounded-lg shadow-sm border p-6">
              ...
              <div className="space-y-4 text-sm">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">Read on iPad or Tablet</p>
                    <p className="text-gray-600">Enjoy an interactive, PowerPoint-style reading experience perfect for modern kids.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Share the digital reader link or email the PDF to grandparents, friends, and family.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
